...
class trainModel():
    ...
    def training(self):
        ...
        train_dataloader, validation_dataloader, prediction_dataloader, test_input_id=trainModel.getData(self)
...
model=trainModel(trainfile=train_file,devfile=dev_file,testfile=test_file,bertModel=clinicalBert,output_dir=output_dir)

#if training model
# model.training()

#evaluation using an already saved model
model.evaluation()
